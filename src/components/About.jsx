  ...
  return (
    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 3 }}>
        <h2 style={{ color: '#fff', textShadow: '2px 2px 8px rgba(0,0,0,0.5)' }}>About Sharing Excess</h2>
        <p style={{ fontSize: '1.2rem', fontWeight: 500, color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>
        ...
        <p style={{ color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>
        ...
        <div style={{ margin: '40px 0', background: 'rgba(40,167,69,0.92)', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.18)', padding: '30px', textAlign: 'left' }}>
          <h3 style={{ color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>Why This Matters</h3>
          <ul style={{ fontSize: '1.1rem', lineHeight: 1.7, color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>
        ...
        <div style={{ margin: '40px 0', background: 'rgba(0,0,0,0.65)', borderRadius: '12px', padding: '30px', textAlign: 'left' }}>
          <h3 style={{ color: '#28a745', textShadow: '1px 1px 6px rgba(0,0,0,0.7)' }}>How It Works</h3>
          <ol style={{ fontSize: '1.1rem', lineHeight: 1.7, color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>
        ...
        <div style={{ margin: '40px 0', background: 'rgba(40,167,69,0.92)', borderRadius: '12px', padding: '30px', textAlign: 'center' }}>
          <h3 style={{ color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>Join Us in Making a Difference</h3>
          <p style={{ fontSize: '1.15rem', color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>
        ...
        <h2 style={{ color: '#fff', textShadow: '2px 2px 8px rgba(0,0,0,0.5)' }}>Contact Us</h2>
        <p style={{ color: '#fff', textShadow: '1px 1px 6px rgba(0,0,0,0.5)' }}>
